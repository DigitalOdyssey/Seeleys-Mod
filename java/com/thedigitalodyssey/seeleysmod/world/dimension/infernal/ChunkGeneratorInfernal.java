...
public class ChunkGeneratorInfernal implements IChunkGenerator {
	
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = Blocks.MYCELIUM.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK1 = ModBlocks.TYLINE.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = ModBlocks.HARD_TYLINE.getDefaultState();
    ...
    */
    ...
    public ChunkGeneratorInfernal(World world, boolean generate, long seed) {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z) {
        ...
        for (int i = 0; i < abyte.length; ++i) {
            abyte[i] = (byte)Biome.getIdForBiome(ModBiomes.INFERNAL_DIMENSION);
        }
